...
@section('title') Approval Vendor @endsection
@section('css')
    <!-- DataTables -->
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between header-title" style="margin-bottom:25px;">
                ...
                <div class="header-nav">
                    <span class="header-word md-0">Approval Vendor &nbsp;&nbsp;</span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">Detail Approval Vendor</h4>
                        </div>
                    </div>
                </div>
            <!-- end page title -->
                                ...
                                <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="loading_date" type="text" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true" class="form-control datePicker loading_date_val">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group text-right">
                                            <input type="button" class="submit-order btn btn-primary " value="Submit">
