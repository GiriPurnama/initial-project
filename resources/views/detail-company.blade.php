...
@section('title') Detail Company @endsection
@section('css')
    <!-- DataTables -->
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between header-title" style="margin-bottom:25px;">
                ...
                <div class="header-nav">
                    <span class="header-word md-0">Company &nbsp;&nbsp;</span>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body title-expedition">
                                        <div class="media">
                                            <div class="media-body overflow-hidden content-size">
                                                <h2 class="font-bold center">0 - 7 Days</h2>
                                            </div>
                                            <div class="media-body overflow-hidden content-size">
                                                <span>Grand Total</span>
                                                <h4 class="font-bold margin-min-7">6426</h4>
                                            </div>
                                            <div class="content-size">
                                                <span>Contribution</span>
                                                <h4 class="font-bold margin-min-17">48% / 9%</h4>
                                            </div>
                                        </div>
                                    </div>
